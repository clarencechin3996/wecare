...
<head>
  ...
  <title>WeCare - Medical Consultation</title>
...
<body>
            ...
            <li class="nav-item">
              <div class="w3-container" style="padding-right: 0px;">
                <div class="w3-dropdown-click">
                  <a class="fa fa-fw fa-user" href="#" style="font-size: 24px;" onclick="myFunction()"
                    class="w3-button w3-black"></a>
                  <div id="Demo" class="w3-dropdown-content w3-bar-block w3-border"
                    style="position:absolute; overflow: hidden; z-index: 11;">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <p><span>We</span>-Care Protection</p>
            </div>
          </div>
          <div class="col-md-4 py-3 py-md-0">
            <div class="card-service wow fadeInUp">
              ...
              <p><span>We</span>-Care Pharmacy</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="page-section bg-light" style="padding-bottom: 0px;">
    <div class="container">
