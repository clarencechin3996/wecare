                ...
                <div class="">
                    <div class="main-menu-header">
                        ...
                        <div class="user-details">
                            ...
                            <div id="more-details">Receptionist<i class="fa fa-chevron-down m-l-5"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Home Page</h5>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="sample-page.html"><i class="feather icon-home"></i></a></li>
